...
async function getPatientDashboardData(patientUserId, options = {}) {
    ...
    const myDoctors = [...doctorIdsVisited].map((did) => {
        ...
        return {
            ...
            avatar: info.avatar ?? doctorAvatarUrl(info?.fullName, 128),
    ...
    const healthRecords = visitNotes.map((n) => {
        ...
        return {
            ...
            avatar: doc.avatar ?? doctorAvatarUrl(doc?.fullName, 64),
        };
    });
    ...
    return {
        patient: {
            ...
            avatar: profile.avatar ?? patientAvatarUrl(user.fullName, 256),
        },
        stats: {
